...
namespace SportApp.ProductsServices.Infrastructure.EntityFramework.Migrations
{
    ...
    [Migration("20240409042645_AlterRelationProductAllergies")]
    partial class AlterRelationProductAllergies
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SportApp.ProductsServices.Domain.ProductService.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 9, 4, 26, 45, 148, DateTimeKind.Utc).AddTicks(3007),
                            CreatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6"),
                            Description = "This is the default category",
                            Enabled = true,
                            Name = "Default Category",
                            UpdatedAt = new DateTime(2024, 4, 9, 4, 26, 45, 148, DateTimeKind.Utc).AddTicks(3015),
            ...
            modelBuilder.Entity("SportApp.ProductsServices.Domain.ProductService.Plan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 9, 4, 26, 45, 148, DateTimeKind.Utc).AddTicks(9636),
                            CreatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6"),
                            Description = "Basic Plan",
                            Enabled = true,
                            Name = "Basic",
                            Price = 0L,
                            UpdatedAt = new DateTime(2024, 4, 9, 4, 26, 45, 148, DateTimeKind.Utc).AddTicks(9636),
                            UpdatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6")
                        },
                        new
                        {
                            Id = new Guid("2c312559-173d-4239-a03d-2fdb3f219fa5"),
                            CreatedAt = new DateTime(2024, 4, 9, 4, 26, 45, 148, DateTimeKind.Utc).AddTicks(9641),
                            CreatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6"),
                            Description = "Intermediate Plan",
                            Enabled = true,
                            Name = "Intermediate",
                            Price = 50L,
                            UpdatedAt = new DateTime(2024, 4, 9, 4, 26, 45, 148, DateTimeKind.Utc).AddTicks(9641),
                            UpdatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6")
                        },
                        new
                        {
                            Id = new Guid("7ee7db76-77c2-4353-a509-ebe4fbe4aed4"),
                            CreatedAt = new DateTime(2024, 4, 9, 4, 26, 45, 148, DateTimeKind.Utc).AddTicks(9644),
                            CreatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6"),
                            Description = "Premium Plan",
                            Enabled = true,
                            Name = "Premium",
                            Price = 150L,
                            UpdatedAt = new DateTime(2024, 4, 9, 4, 26, 45, 148, DateTimeKind.Utc).AddTicks(9644),
                            UpdatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6")
                        });
                });
