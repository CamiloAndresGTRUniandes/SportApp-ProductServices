...
namespace SportApp.ProductsServices.Infrastructure.EntityFramework.Migrations
{
    ...
    [Migration("20240505035730_AlterTrainingtables")]
    partial class AlterTrainingtables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SportApp.ProductsServices.Domain.ProductService.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 5, 5, 3, 57, 29, 114, DateTimeKind.Utc).AddTicks(2816),
                            CreatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6"),
                            Description = "This is the default category",
                            Enabled = true,
                            Name = "Default Category",
                            UpdatedAt = new DateTime(2024, 5, 5, 3, 57, 29, 114, DateTimeKind.Utc).AddTicks(2818),
                            UpdatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6")
                        },
                        new
                        {
                            Id = new Guid("be8e2306-8bc9-49cc-8d43-a76820370994"),
                            CreatedAt = new DateTime(2024, 5, 5, 3, 57, 29, 114, DateTimeKind.Utc).AddTicks(2821),
                            CreatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6"),
                            Description = "Categoría para eventos de todo tipo",
                            Enabled = true,
                            Name = "Eventos",
                            UpdatedAt = new DateTime(2024, 5, 5, 3, 57, 29, 114, DateTimeKind.Utc).AddTicks(2821),
                            UpdatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6")
                        },
                        new
                        {
                            Id = new Guid("a649e6a9-f667-4e73-b8b6-3816c7e554eb"),
                            CreatedAt = new DateTime(2024, 5, 5, 3, 57, 29, 114, DateTimeKind.Utc).AddTicks(2824),
                            CreatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6"),
                            Description = "Categoría para productos de todo tipo",
                            Enabled = true,
                            Name = "Productos",
                            UpdatedAt = new DateTime(2024, 5, 5, 3, 57, 29, 114, DateTimeKind.Utc).AddTicks(2824),
                            UpdatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6")
                        },
                        new
                        {
                            Id = new Guid("60d40a85-78ca-4b75-b75f-76cee4896ead"),
                            CreatedAt = new DateTime(2024, 5, 5, 3, 57, 29, 114, DateTimeKind.Utc).AddTicks(2826),
                            CreatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6"),
                            Description = "Categoría para servicios de todo tipo",
                            Enabled = true,
                            Name = "Servicios",
                            UpdatedAt = new DateTime(2024, 5, 5, 3, 57, 29, 114, DateTimeKind.Utc).AddTicks(2827),
                            UpdatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6")
                        },
                        new
                        {
                            Id = new Guid("03388722-321f-4b6a-963e-104eb73d17c2"),
                            CreatedAt = new DateTime(2024, 5, 5, 3, 57, 29, 114, DateTimeKind.Utc).AddTicks(2830),
                            CreatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6"),
                            Description = "Categoría para planes de todo tipo",
                            Enabled = true,
                            Name = "Planes",
                            UpdatedAt = new DateTime(2024, 5, 5, 3, 57, 29, 114, DateTimeKind.Utc).AddTicks(2830),
                            UpdatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6")
                        });
                });
            ...
            modelBuilder.Entity("SportApp.ProductsServices.Domain.ProductService.Plan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 5, 5, 3, 57, 29, 115, DateTimeKind.Utc).AddTicks(1563),
                            CreatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6"),
                            Description = "Basic Plan",
                            Enabled = true,
                            Name = "Basic",
                            Price = 0L,
                            UpdatedAt = new DateTime(2024, 5, 5, 3, 57, 29, 115, DateTimeKind.Utc).AddTicks(1565),
                            UpdatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6")
                        },
                        new
                        {
                            Id = new Guid("2c312559-173d-4239-a03d-2fdb3f219fa5"),
                            CreatedAt = new DateTime(2024, 5, 5, 3, 57, 29, 115, DateTimeKind.Utc).AddTicks(1568),
                            CreatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6"),
                            Description = "Intermediate Plan",
                            Enabled = true,
                            Name = "Intermediate",
                            Price = 50L,
                            UpdatedAt = new DateTime(2024, 5, 5, 3, 57, 29, 115, DateTimeKind.Utc).AddTicks(1568),
                            UpdatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6")
                        },
                        new
                        {
                            Id = new Guid("7ee7db76-77c2-4353-a509-ebe4fbe4aed4"),
                            CreatedAt = new DateTime(2024, 5, 5, 3, 57, 29, 115, DateTimeKind.Utc).AddTicks(1571),
                            CreatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6"),
                            Description = "Premium Plan",
                            Enabled = true,
                            Name = "Premium",
                            Price = 150L,
                            UpdatedAt = new DateTime(2024, 5, 5, 3, 57, 29, 115, DateTimeKind.Utc).AddTicks(1571),
                            UpdatedBy = new Guid("3bfc0e87-e3bb-46b4-9f0a-b0d264fcd6b6")
                        });
                });
